...
public interface ArticleRepository {
	...
	public List<Article> getForPrintArticles(int boardId, @Param("limitStart") int limitStart,
			@Param("limitTake") int limitTake, String searchKeywordTypeCode, String searchKeyword);
